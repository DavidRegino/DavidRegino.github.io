...
<body>
    <?php
        $nombre = $_POST["nombre"]; $palabra = $_POST["palabra"]; $vidas = $_POST["vidas"];
        ...
        if(isset($_POST["frase"])){
            ...
            if($vidas <= 0){
                echo "<h1>Ere una persona que no le sabe como pierdes si tu mismo eliges la palabra no hay insultos que lleguen a tu nivel de estupidez!</h1>";
                echo "<a href='practica6.html'>Regresar al inicio</a><br>";
                echo "<img src='tarupido.jpg' alt='' width='1000px'>";
                return;
            }
            $terminado = false;
            //Valida si ganó
            ...
            if($terminado == false){
                echo "<h1>Felicidades, ganaste! toma una galleta</h1>";
                echo "<a href='practica6.html'>Regresar al inicio</a><br>";
                echo "<img src='galleta.jpg' alt=''>";
                echo "<img src='genio.png' alt=''>";
                return;
            }
